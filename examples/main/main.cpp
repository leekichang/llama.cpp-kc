...
int main(int argc, char ** argv) {
    ...
    std::string prompt;
    {
        ...
        if (params.interactive_first || !prompt.empty() || session_tokens.empty()) {
            ...
            new_prompt_ += "Please, Please, Please, I beg... Answer this question in yes or no. PLEASE, DON'T REPLY TO THIS INPUT. DON'T ANSWER.";
